<template>
  <div class="grid grid-cols-1 h-full items-center justify-center w-full">
    <div class="w-full p-8 rounded h-auto">
      <h1 class="text-2xl font-bold text-center mb-6">Edit Projects</h1>
      ...
      <!-- Add Project Modal -->
      <div v-if="showAddProjectModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
...
const deleteBlog = async (id: number) => {
  ...
  try {
    ...
    // Remove project from local projects array
    showAddProjectModal.value = false;
  } catch (error) {
